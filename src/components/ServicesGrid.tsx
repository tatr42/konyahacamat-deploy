...
const services = [
  ...
  {
    icon: ShoppingBag,
    title: "Sülük & Malzeme Satışı",
    linkTitle: "Tıbbi Sülük Satışı, Hacamat Kupaları ve Ekipman",
    sub: "Tıbbi Sülük & Kupalar",
    desc: "Canlı tıbbi sülük (Hirudo medicinalis) satışı, profesyonel hacamat kupaları, vakum setleri ve steril lanseler. Toptan ve perakende, kurs mezunlarına özel indirim.",
    href: "/malzemeler",
    badge: "Toptan Mevcut",
