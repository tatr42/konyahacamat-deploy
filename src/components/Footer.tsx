      ...
      <div className="container-site relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-6">
            <Link title="Konyahacamat" href="/" className="inline-block group">
            ...
            <div className="flex gap-4">
              <a title="Konyahacamat Bağlantısı" href="https://www.instagram.com/konya_hacamat" target="_blank" rel="nofollow noopener noreferrer" aria-label="Konya Hacamat Instagram" className="w-11 h-11 rounded-2xl bg-white/5 flex items-center justify-center hover:bg-teal hover:text-anthracite-dark transition-all duration-300 border border-white/10">
                <Instagram size={20} />
              </a>
              <a title="Konyahacamat Bağlantısı" href="https://www.facebook.com/konyahacamat.com.tr/" target="_blank" rel="nofollow noopener noreferrer" aria-label="Konya Hacamat Facebook" className="w-11 h-11 rounded-2xl bg-white/5 flex items-center justify-center hover:bg-teal hover:text-anthracite-dark transition-all duration-300 border border-white/10">
                <Facebook size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-semibold">
              <li><Link title="Konyahacamat" href="/hizmetler" className="text-white/60 hover:text-teal transition-colors">Hacamat Tedavisi</Link></li>
              <li><Link title="Konyahacamat" href="/hizmetler/suluk" className="text-white/60 hover:text-teal transition-colors">Sülük Terapisi</Link></li>
              <li><Link title="Konyahacamat" href="/almanya-hacamat" className="text-white/60 hover:text-teal transition-colors font-bold">Almanya Şubemiz</Link></li>
              <li><Link title="Konyahacamat" href="/egitimler" className="text-white/60 hover:text-teal transition-colors">Eğitim & Kurslar</Link></li>
              <li><Link title="Konyahacamat" href="/malzemeler" className="text-white/60 hover:text-teal transition-colors">Malzeme Satışı</Link></li>
              <li><Link title="Konyahacamat" href="/takvim" className="text-white/60 hover:text-teal transition-colors">Sünnet Takvimi</Link></li>
              <li><Link title="Konyahacamat" href="/iletisim" className="text-white/60 hover:text-teal transition-colors">Bize Ulaşın</Link></li>
            </ul>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-2 space-y-2">
                ...
                <div>
                  ...
                  <a title="Konyahacamat Bağlantısı" href="tel:05544062383" className="block text-xl font-display font-bold text-white hover:text-teal transition-colors">
                    0554 406 23 83
                  </a>
                </div>
                <div>
                  <span className="text-[9px] text-white/30 uppercase tracking-widest">🇩🇪 Almanya</span>
                  <a title="Konyahacamat Bağlantısı" href="tel:+491634492870" className="block text-xl font-display font-bold text-white hover:text-teal transition-colors">
                    +49 163 449 28 70
                  </a>
                </div>
              </div>
              <div>
                ...
                <a title="Konyahacamat Bağlantısı" href="https://www.konyahacamat.net" className="text-teal text-sm hover:underline font-bold">
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[10px] text-white/30 font-bold uppercase tracking-widest text-center md:text-left">
            ...
            <a title="Konyahacamat Bağlantısı" href="https://tataryazilim.com" target="_blank" rel="nofollow noopener noreferrer" className="hover:text-teal transition-colors">
              tataryazilim.com
            </a>
          </p>
          <div className="flex gap-8 text-[10px] font-black uppercase tracking-widest">
            <Link title="Konyahacamat" href="/gizlilik" className="text-white/30 hover:text-teal transition-colors">Gizlilik Politikası</Link>
            <Link title="Konyahacamat" href="/kvkk" className="text-white/30 hover:text-teal transition-colors">KVKK</Link>
          </div>
        </div>
      </div>
    </footer>
