...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const articleSchema = {
    ...
    author: { "@type": "Organization", name: "Ebusadullah Hacamat & Akademi", url: "/" },
    publisher: { "@type": "Organization", name: "Ebusadullah Hacamat & Akademi", logo: { "@type": "ImageObject", url: "/logo.webp" } },
    url: `/blog/${post.slug}`,
      ...
      <div className="container-site max-w-3xl">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-6 mt-6 text-white/30 text-sm">
            ...
            <span className="flex items-center gap-1"><Eye size={14} /> <ViewCounter slug={post.slug} initialCount={post.views || 0} /></span>
          </div>
        </div>
