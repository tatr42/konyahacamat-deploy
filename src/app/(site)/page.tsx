...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Hacamat ne işe yarar?", acceptedAnswer: { "@type": "Answer", text: "Hacamat; kronik bel ve boyun hassasiyetleri, baş ağrısı şikâyetleri, tansiyon ve dolaşım dengesizlikleri, uyku düzensizlikleri, genel detoks ve bağışıklık destekleme amacıyla geleneksel kaynaklarda faydalı olduğu belirtilen kadim bir uygulamadır." } },
