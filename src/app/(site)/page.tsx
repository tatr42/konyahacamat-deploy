...
const getFaqSchema = () => ({
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Konya'da hacamat nerede yaptırılır?", acceptedAnswer: { "@type": "Answer", text: `Konya Selçuklu'da Ebusadullah Hacamat & Akademi olarak ${getYearsExpStr()} yıldır profesyonel hacamat hizmeti sunuyoruz. Adres: Nişantaş Mh. Dr. Hulusi Baybal Cd. Selçuklu/Konya. Randevu için: 0554 406 23 83` } },
