      ...
      <section className="pt-20 pb-20 relative overflow-hidden">
        ...
        <div className="container-site relative z-10">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="https://wa.me/905544062383?text=Hacamat%20tedavisi%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum." title="Türkiye Hacamat İletişim" target="_blank" rel="noopener noreferrer nofollow"
      ...
      <section className="py-20 bg-teal/5 border-y border-teal/10">
        <div className="container-site">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <a href="https://wa.me/905544062383?text=Almanya%20hacamat%20seans%20tarihleri%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum." title="Türkiye Hacamat İletişim"
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/491634492870?text=Hacamat%20randevusu%20almak%20istiyorum." title="Almanya Hacamat İletişim" target="_blank" rel="noopener noreferrer nofollow"
