...
import { X, ChevronLeft, ChevronRight, Phone, MessageCircle, Calendar, ZoomIn, ExternalLink } from 'lucide-react';

export default function BasinClient({ initialItems }: { initialItems: PressItem[] }) {
  const gazeteler = initialItems;
