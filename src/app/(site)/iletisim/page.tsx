            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex gap-4 hover:border-teal/30 transition-colors">
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    <a title="Konyahacamat Bağlantısı" href="tel:05544062383" className="text-white font-bold text-xl hover:text-teal transition-colors">0554 406 23 83</a>
                    <div className="text-white/40 text-xs">🇹🇷 Türkiye</div>
                  </div>
                  <div>
                    <a title="Konyahacamat Bağlantısı" href="tel:+491634492870" className="text-white font-bold text-xl hover:text-teal transition-colors">+49 163 449 28 70</a>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex gap-4 hover:border-teal/30 transition-colors">
                ...
                <div>
                  ...
                  <a title="Konyahacamat Bağlantısı" href="https://wa.me/905544062383" target="_blank" rel="nofollow noopener noreferrer" className="text-white font-bold hover:text-teal transition-colors">wa.me/905544062383</a>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex gap-4 hover:border-teal/30 transition-colors">
                ...
                <div>
                  ...
                  <a title="Konyahacamat Bağlantısı" href="mailto:info@konyahacamat.net" className="text-white font-bold hover:text-teal transition-colors">info@konyahacamat.net</a>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  <a title="Konyahacamat Bağlantısı" href="https://wa.me/905544062383?text=Merhaba%2C%20hacamat%20randevusu%20almak%20istiyorum."
                  ...
                  <a title="Konyahacamat Bağlantısı" href="https://wa.me/905544062383?text=Merhaba%2C%20e%C4%9Fitim%20programlar%C4%B1%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum."
                    target="_blank" rel="nofollow noopener noreferrer"
                  ...
                  <a title="Konyahacamat Bağlantısı" href="https://wa.me/491634492870?text=Merhaba%2C%20Almanya%20seans%20tarihleri%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum."
                    target="_blank" rel="nofollow noopener noreferrer"
