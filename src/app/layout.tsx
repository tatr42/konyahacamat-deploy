...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "ebusadullah hacamat", "konya geleneksel tıp", "hacamat akademi",
    "hacamat kursu konya", "hacamat eğitimi", "almanya hacamat",
    "islamda hacamat", "sünnet tedavisi", "konyahacamat"
  ],
