...
export const metadata: Metadata = {
  ...
  description: "Konya'nın en köklü hacamat merkezi. Kuru & yaş hacamat, sülük terapisi, sertifikalı hacamat kursu. 15+ yıl deneyim, CE steril malzeme. Almanya seansları. Randevu: 0554 406 23 83",
  alternates: { canonical: "https://konyahacamat.net" },
  openGraph: {
    title: "Konya Hacamat | Ebusadullah Hacamat & Akademi",
    description: "Konya'nın köklü hacamat merkezi. Kuru & yaş hacamat, sülük terapisi, uzmanlık kursları. 15+ yıl deneyim. Almanya periyodik seansları.",
...
const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Konya'da hacamat nerede yaptırılır?", acceptedAnswer: { "@type": "Answer", text: "Konya Selçuklu'da Ebusadullah Hacamat & Akademi olarak 15+ yıldır profesyonel hacamat hizmeti sunuyoruz. Adres: Nişantaş Mh. Dr. Hulusi Baybal Cd. Selçuklu/Konya. Randevu için: 0554 406 23 83" } },
